...
namespace EmployeeProj.Server.Migrations
{
    ...
    [Migration("20240917170920_tryfix3")]
    partial class tryfix3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeProj.Server.Models.Evaluation", b =>
                {
                    b.HasOne("EmployeeProj.Server.Models.ManagerRequest", "OneManager")
                        .WithMany("Evaluations")
                        .HasForeignKey("OneManagerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
